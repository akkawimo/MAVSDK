...
TelemetryServerImpl::publish_distance_sensor(TelemetryServer::DistanceSensor distance_sensor)
{
    ...
    mavlink_msg_distance_sensor_pack(
        ...
        &msg,
        0,
        static_cast<uint16_t>(static_cast<double>(distance_sensor.minimum_distance_cm)),
        static_cast<uint16_t>(static_cast<double>(distance_sensor.maximum_distance_cm)),
        static_cast<uint16_t>(static_cast<double>(distance_sensor.current_distance_cm)),
