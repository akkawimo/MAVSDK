...
public:
    ...
    struct DistanceSensor {
        ...
        /**
         * @brief Stream operator to print information about a `Telemetry::Type`.
         *
         * @return A reference to the stream.
         */
        friend std::ostream&
        operator<<(std::ostream& str, Telemetry::DistanceSensor::Type const& type);
        ...
        /**
         * @brief Stream operator to print information about a `Telemetry::Rotation`.
         *
         * @return A reference to the stream.
         */
        friend std::ostream&
        operator<<(std::ostream& str, Telemetry::DistanceSensor::Rotation const& rotation);
        ...
        float covariance_m2{float(NAN)}; /**< @brief */
