...
Action::Result ActionImpl::winch_relax(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_relax_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_relative_length_control(const uint32_t instance, const float length, const float rate)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_relative_length_control_async(instance, length, rate, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_rate_control(const uint32_t instance, const float rate)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_rate_control_async(instance, rate, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_lock(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_lock_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_deliver(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_deliver_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_hold(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_hold_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_retract(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_retract_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_load_line(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_load_line_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_abandon_line(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_abandon_line_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::winch_load_payload(const uint32_t instance)
{
    auto prom = std::promise<Action::Result>();
    auto fut = prom.get_future();

    winch_load_payload_async(instance, [&prom](Action::Result result) {
        prom.set_value(result);
    });
...
Action::Result ActionImpl::gripper_grab(const uint32_t instance)
{
    ...
    gripper_grab_async(instance, [&prom](Action::Result result) { prom.set_value(result); });
...
Action::Result ActionImpl::gripper_release(const uint32_t instance)
{
    ...
    gripper_release_async(instance, [&prom](Action::Result result) { prom.set_value(result); });
...
void ActionImpl::winch_relax_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::Relaxed);
...
void ActionImpl::winch_relative_length_control_async(const uint32_t instance, const float length, const float rate, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::RelativeLengthControl);
...
void ActionImpl::winch_rate_control_async(const uint32_t instance, const float rate, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::RateControl);
    command.params.maybe_param4 = rate;
...
void ActionImpl::winch_lock_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::Lock);
...
void ActionImpl::winch_deliver_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::Deliver);
...
void ActionImpl::winch_hold_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::Hold);
...
void ActionImpl::winch_retract_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::Retract);
...
void ActionImpl::winch_load_line_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::LoadLine);
...
void ActionImpl::winch_abandon_line_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::AbandonLine);
...
void ActionImpl::winch_load_payload_async(const uint32_t instance, const Action::ResultCallback& callback)
{
    MavlinkCommandSender::CommandLong command{};

    command.command = MAV_CMD_DO_WINCH;
    command.params.maybe_param1 = instance;
    command.params.maybe_param2 = static_cast<float>(Action::WinchAction::LoadPayload);
